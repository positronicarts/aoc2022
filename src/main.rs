...
mod test {
    ...
    #[test]
    fn day12() {
        assert_eq!(day12::Day12 {}.test(), (31, 29));
    }

    #[test]
    fn day13() {
        assert_eq!(day13::Day13 {}.test(), (13, 140));
    }

    #[test]
    fn day14() {
        assert_eq!(day14::Day14 {}.test(), (24, 93));
    }

    #[test]
    fn day15() {
        assert_eq!(day15::Day15 {}.test(), (26, 56000011));
    }

    #[test]
    fn day16() {
        assert_eq!(day16::Day16 {}.test(), (1651, 0));
    }

    #[test]
    fn day17() {
        assert_eq!(day17::Day17 {}.test(), (3068, 1514285714288));
    }

    #[test]
    fn day18() {
        assert_eq!(day18::Day18 {}.test(), (64, 58));
    }
}
